...
namespace LuaFramework {
    public class Util {
        ...
        public static void LoadSence(int level) {
            Application.LoadLevel(level);
        }
        public static IEnumerator LoadAsyScene(int SceneID, LuaFunction func = null)
        {
        ...
        //  StartCoroutine(LoadScene(SceneID, func));
        //}
        public static void WritePlayerPrefs(string key,object obj)
        {
            if(obj is float)
            {
        ...
        //端点赋值
       public static void SetObjLocalPos(GameObject obj, float x, float y, float z) { obj.transform.localPosition = new Vector3(x, y, z); }
    }
}