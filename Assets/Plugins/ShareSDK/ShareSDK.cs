...
namespace cn.sharesdk.unity3d
{
	...
	public class ShareSDK : MonoBehaviour 
	{
		...
		#if UNITY_ANDROID
        public string appKey = "16e18210f8854";
		#elif UNITY_IOS
		public string appKey = "16e18210f8854";
#else
        public string appKey ="16e18210f8854";
...
//             default:
//             if (showAutoInfoHandler!=null)
//                 showAutoInfoHandler(reqID, ResponseState.Success, platform, res);

 
            Debug.Log("OnComplete, action:" + action);
            Debug.Log("OnComplete, res:" + res.ToString());
            break;
			}
		}
