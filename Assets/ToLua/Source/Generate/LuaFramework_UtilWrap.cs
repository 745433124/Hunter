...
public class LuaFramework_UtilWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("LoadAsyScene", LoadAsyScene);
		L.RegFunction("WritePlayerPrefs", WritePlayerPrefs);
		L.RegFunction("getGUID", getGUID);
		L.RegFunction("SetObjLocalPos", SetObjLocalPos);
	...
	static int GetOS(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 0);
			string o = LuaFramework.Util.GetOS();
			LuaDLL.lua_pushstring(L, o);
			return 1;
		}
		catch(Exception e)
	...
	static int LoadSence(IntPtr L)
	{
		try
		{
			...
			LuaFramework.Util.LoadSence(arg0);
			return 0;
		}
		catch(Exception e)
		{
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int LoadAsyScene(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 2);
			...
			System.Collections.IEnumerator o = LuaFramework.Util.LoadAsyScene(arg0, arg1);
			ToLua.Push(L, o);
			return 1;
		}
		catch(Exception e)
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int WritePlayerPrefs(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 2);
			string arg0 = ToLua.CheckString(L, 1);
			object arg1 = ToLua.ToVarObject(L, 2);
			LuaFramework.Util.WritePlayerPrefs(arg0, arg1);
			return 0;
		}
		catch(Exception e)
		{
	...
	static int getGUID(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 0);
			string o = LuaFramework.Util.getGUID();
			LuaDLL.lua_pushstring(L, o);
			return 1;
		}
		catch(Exception e)
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int SetObjLocalPos(IntPtr L)
	{
		try
		{
			...
			LuaFramework.Util.SetObjLocalPos(arg0, arg1, arg2, arg3);
			return 0;
		}
		catch(Exception e)
		{
